...
import Courasel from "../Home\ Page/Courasel";
...
function Movies() {
  return (
    <div>
        ...
        <div className="moviescomponentcourasel">
        <Courasel></Courasel>
        </div>
        ...
        {MoviesData.map((x) => {
            return (
            <Link to={x.route}>
                <div className="moviescomponentdiv">
                <img src={x.imageLink} alt="" className="moviescompnentimg"/>
                <h2 className="moviescomponenth2">{x.title}</h2>
                <p className="moviescomponentp">{x.certificate}</p>
                <p className="moviescomponentp">{x.languages}</p>
                </div>
            </Link>
            );
        })}
