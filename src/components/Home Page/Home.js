...
function Home() {
  return (
    <div>
        ...
        <div className="shows">
                <Movies
                    img="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@like_202006280402.png,ox-24,oy-617,ow-29:ote-NjEwLjlLIExpa2Vz,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00330424-ahkfdbxxjp-portrait.jpg"
                    name="Jawan"
                    para="Action/Thriller"></Movies>
